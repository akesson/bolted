...
- [IDE diagnostics lie after sub-agent work](ide-diagnostics-lie-after-subagent-work.md) — 4-of-6 milestones showed stale hard errors against green gates; only gates re-run on the branch count
