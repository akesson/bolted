...
Headline finding — push-mode stream delivery generated by the **0.27.3 CLI** stalls
permanently under concurrent load (mechanism + fix identified). **Moot at 0.27.5**: the CLI
main pins generates rewritten stream machinery, and a 2026-07-15 re-run of these probes
converges cleanly — see the provenance banner in
